...
namespace Abstraction.EmployeeSpecialities
{
    /// <summary>
    ///     Repository definition for <c>EmployeeSpeciality</c>.
    /// </summary>
    /// <remarks>
    ///     <para>
    ...
    ///     </para>
    /// </remarks>
    public interface IEmployeeSpecialityRepository
    {
        /// <summary>
        ///     Create a new entity.
        /// </summary>
        ...
        void Create(EmployeeSpeciality entity);
        ...
        /// <exception cref="ArgumentNullException">entity</exception>
        /// <exception cref="DataException">Db operation failed</exception>
        void Delete(EmployeeSpeciality entity);
        ...
        /// </remarks>
        /// <exception cref="DataException">DB operation failed (exception will include command details)</exception>
        void Update(EmployeeSpeciality entity);
    }
}