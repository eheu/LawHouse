...
namespace Abstraction.ServiceSpecialities
{
    /// <summary>
    ///     Repository definition for <c>ServiceSpeciality</c>.
    /// </summary>
    /// <remarks>
    ///     <para>
    ...
    ///     </para>
    /// </remarks>
    public interface IServiceSpecialityRepository
    {
        /// <summary>
        ///     Create a new entity.
        /// </summary>
        ...
        void Create(ServiceSpeciality entity);
        ...
        /// <exception cref="ArgumentNullException">entity</exception>
        /// <exception cref="DataException">Db operation failed</exception>
        void Delete(ServiceSpeciality entity);
        ...
        /// </remarks>
        /// <exception cref="DataException">DB operation failed (exception will include command details)</exception>
        void Update(ServiceSpeciality entity);
    }
}